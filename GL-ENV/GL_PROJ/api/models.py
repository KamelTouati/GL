...
class Annonce(models.Model):
    ...
    annoncer = models.ForeignKey(
        UserAccount, on_delete=models.CASCADE, related_name='annoncer')
...
class Conversation(models.Model):
    annonce=models.ForeignKey(Annonce,on_delete=models.CASCADE)
    pariticipant1=models.ForeignKey(UserAccount, on_delete=models.CASCADE,related_name='pariticipant1')
    pariticipant2=models.ForeignKey(UserAccount, on_delete=models.CASCADE,related_name='pariticipant2')
    def __str__(self):
